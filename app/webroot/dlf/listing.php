...
*/
$startdir = '/files/';
$home = 'localhost/xpert_8'.$startdir;
...
<div id="container">
  ...
  <div id="listingcontainer">
	...
	if($dirok) {
	?>
	<div><a href="<?php echo $_SERVER['PHP_SELF'].'?dir='.urlencode($dotdotdir);?>" class="<?php echo $class;?>"><?php echo $html->image("/dlf/dirup.png", array('alt' => "Folder")); ?> <strong>..</strong> <em>&nbsp;</em>&nbsp;</a></div>
	<?php
		if($class=='b') $class='w';
		else $class = 'b';
	}
